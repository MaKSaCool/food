...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__.default)('.timer', '2021-02-01');
...
function slider(_ref) {
  ...
  function checkSlider() {
    var key = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new Error("Could not fetch ".concat(url, ", statys: ").concat(res.status));
